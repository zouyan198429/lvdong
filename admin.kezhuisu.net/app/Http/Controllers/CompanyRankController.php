...
class CompanyRankController extends LoginController
{
    protected $model_name = 'CompanyRank';
...
//            $this->judgePowerByObj($request,$resultDatas, $judgeData );
        ...
        return view('companyrank.edit',$resultDatas);
    }
...
//            'orderBy' => ['id'=>'desc'],
    ...
    public function ajax_save(Request $request)
    {
        ...
        $company_id = $this->company_id;
        $rank_name = Common::get($request, 'rank_name');
