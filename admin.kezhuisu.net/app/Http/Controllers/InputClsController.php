...
class InputClsController extends LoginController
{
    protected $model_name = 'SiteProInput';
...
//            $this->judgePowerByObj($request,$resultDatas, $judgeData );
        ...
        return view('inputcls.edit',$resultDatas);
    }
...
//                ['company_id', $this->company_id],
//            ],
           'orderBy' => ['pro_input_sort'=>'desc','id'=>'asc'],
        ];// 查询条件参数
        $relations = '';// 关系
    ...
    public function ajax_save(Request $request)
    {
        ...
        $pro_input_sort = Common::getInt($request, 'pro_input_sort');

        $saveData = [
            'pro_input_name' => $pro_input_name,
            'pro_input_sort' => $pro_input_sort,
        ];
        if($id <= 0){// 新加
