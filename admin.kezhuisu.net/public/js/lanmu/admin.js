...
(function() {
    ...
    document.write("    var admin_type = item.admin_type;");
    ...
    document.write("        <td><a href=\"#\"><%=item.admin_username%><\/a><\/td>");
    document.write("        <td><%=item.type_text%><\/td>");
    document.write("        <td class=\"am-hide-sm-only\"><%=item.real_name%><\/td>");
