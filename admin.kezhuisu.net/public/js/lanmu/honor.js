...
(function() {
    ...
    document.write("        <td><a href=\"\/member\/edit\/<%=item.company_id%>\"><%=item.company_name%><\/a><\/td>");
    document.write("        <td><%=item.company_linkman%><\/td>");
    document.write("        <td><%=item.company_mobile%>&nbsp;&nbsp;<%=item.company_tel%><\/td>");
    document.write("        <td><%=item.area%><\/td>");
    document.write("        <td><a href=\"#\"><img  data-toggle=\"lightbox\"  src=\"<%=item.resource_url%>\" width=\"50\" \/><\/a><\/td>");
