...
function operate_ajax(operate_type,id){
    ...
    switch(operate_type)
    {
        case 'del'://删除
            operate_txt = "删除";
            data = {'id':id}
            ajax_url = "{{ url('api/honor/ajax_del') }}";// /pms/Supplier/ajax_del?operate_type=1
            break;
        case 'pass'://审核通过
            operate_txt = "审核通过";
            data = {'id':id,'status':1}
            ajax_url = "{{ url('api/honor/ajax_status') }}";// /pms/Supplier/ajax_del?operate_type=1
            break;
        case 'notpass'://审核不通过
            operate_txt = "审核不通过";
            data = {'id':id,'status':2}
        ...
        <td>
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    ...
                    <%}%>
                    {{--<button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="action.edit(<%=item.id%>)"><span class="am-icon-pencil-square-o"></span>通过</button>--}}
