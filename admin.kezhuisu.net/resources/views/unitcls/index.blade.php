                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a  href="{{ url('unitcls/edit/0') }}" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        </div>
                    </div>
                </div>
            </div>
...
const AJAX_URL = "{{ url('api/unitcls/ajax_alist') }}";//ajax请求的url/pms/Supplier/ajax_alist
...
function operate_ajax(operate_type,id){
    ...
    switch(operate_type)
    {
        case 'del'://删除
            operate_txt = "删除";
            data = {'id':id}
            ajax_url = "{{ url('api/unitcls/ajax_del') }}";// /pms/Supplier/ajax_del?operate_type=1
            break;
//        case 'batch_del'://批量删除
//            operate_txt = "批量删除";
//            data = {'supplier_id':id}
...
<%for(var i = 0; i<data_list.length;i++){
    ...
    <tr>
        <td><%=item.id%></td>
        <td><%=item.pro_unit_name%></td>
        <td><%=item.pro_unit_order%></td>
        <td>
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
