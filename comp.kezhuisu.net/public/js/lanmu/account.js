...
(function() {
    ...
    document.write("    var account_status = item.account_status;");
    document.write("    var can_modify = false;");
    document.write("    if( item.account_issuper==0 ){ ");
    ...
    document.write("        <td><%=item.account_username%><\/td>");
    document.write("        <td><%=item.wx_account%><\/td>");
    document.write("        <td><%=item.real_name%><\/td>");
    document.write("        <td><%=item.mobile%><\/td>");
    document.write("        <td><%=item.created_at%><\/td>");
    document.write("        <td>");
    document.write("        <%if( account_status == 0){%>");
    document.write("            <span class=\"text-green\"><%=item.account_statu_text%><\/span>");
    document.write("        <%}else{%>");
