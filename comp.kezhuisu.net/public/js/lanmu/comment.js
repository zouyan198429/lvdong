...
(function() {
    ...
    document.write("    <td><%=item.comment_mobile%><\/td>");
    document.write("    <td><%=item.comment_content%><\/td>");
    ...
    document.write("            <a href=\"#\" class=\"btn btn-xs btn-primary\" onclick=\"action.pass(<%=item.id%>)\">通过<\/a>");
    document.write("            <a href=\"#\" class=\"btn btn-xs btn-primary\"  onclick=\"action.notpass(<%=item.id%>)\">不通过<\/a> ");
    document.write("        <%}%>");
    document.write("        <%if( false){%>");
