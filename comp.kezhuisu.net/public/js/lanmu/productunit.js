...
(function() {
    ...
    document.write("    if( status == 0 || status == 2 ){");
    ...
    document.write("        <\/td>");
    document.write("        <td><%=item.pro_input_batch%><\/td>");
    ...
    document.write("        <%}else if( status == 3){%>");
    document.write("            <span class=\"text-gray\"><%=item.status_text%><\/span>");
    document.write("        <%}%>");
    document.write("        <\/td>");
    document.write("        <td>");
