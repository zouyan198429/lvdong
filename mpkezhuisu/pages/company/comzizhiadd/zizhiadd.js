...
// pages/company/comzizhiadd/zizhiadd.js
  ...
  onReachBottom: function () {
    ...
    initValidate() {
        ...
        const messages = {
            honor_name: {
                required: '请输入证书名称',
                minlength: '证书名称长度不少于2位',
                maxlength: '证书名称长度不多于26位',
            },
        };
    ...
    saveRepos(params) {
        let apiName = '保存记录';
        let apiPath = '/company/ajax_img_save';
